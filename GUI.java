...
public class GUI extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
        ...
        //Title.setBounds(10, 130, 80, 25);
        //panel.add(Title);

        panel.setLayout(null);
        stats = new JLabel("Type a five letter word");
        stats.setBounds(90, 20, 180, 25);
        panel.add(stats);

        userText1 = new JTextField();
        userText1.addActionListener(new GUI());
        userText1.setBounds(120, 70 + (0 * 25), 80, 25);
        panel.add(userText1);

        JButton button = new JButton("Enter");
        button.setBounds(130, 250, 80, 25);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            labels[i].setBounds(130, 70 + (i * 25), 80, 25);
            panel.add(labels[i]);
        }
    ...
    public static void StartWordle() {
        ...
        stats.setText("<html><font size='3' color=red> " + "Type A Five Letter Word "  + "</font> <font");
    ...
    public static void EndWordle() {
        ...
        if (!done) stats.setText("<html><font size='3' color=red> " + "The Answer Was: " + new String(answerChoosen) + ". You wasted \n " + ((System.currentTimeMillis() - startTime) / 1000) + " seconds (:" + "</font> <font");
        else  stats.setText("<html><font size='3' color=green> " + "You Found The Answer in \n " + ((System.currentTimeMillis() - startTime) / 1000) + " seconds and " + tries + " tries." + "</font> <font");
    }
    ...
    public static void EnterWord(){ //if its good, actually submit the word for checking
        if ( IsAValidWord(userText1.getText(), possibleWords) ) {ButtonPressed(); stats.setText("  ");}
        else{ System.out.println("Invalid Word"); 
        stats.setText("<html><font size='3' color=red> " + "Invalid Word"  + "</font> <font");}
    }
...
//just reset answer every time
    ...
    public static boolean IsAValidWord(String input, String[] possibleWords) {
        if (input.length() < 5) {
            System.out.println("Wordle: Invalid word length");
            stats.setText("<html><font size='3' color=red> " + "Invalid Word length "  + "</font> <font");
            return false;
        }
